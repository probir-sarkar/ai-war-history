/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e881436c4a0b0855ec478f104c27c840)
// Runtime types generated with workerd@1.20260515.1 2025-09-02 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_Env {
	KV: KVNamespace;
	DATABASE_URL: Hyperdrive;
	CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_DATABASE_URL: string;
	DATABASE_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_DATABASE_URL" | "DATABASE_URL">> {}
}
